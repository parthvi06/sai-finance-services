                        ...
                        <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div className="panel panel-default">
                                ...
                                <div id="collapseOne" className="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                    ...
                                    Many people have crowded or crooked teeth. Orthodontic treatment will straighten the teeth or move them into a better position. This can improve their appearance and the way the teeth bite together, while also making them easier to clean.<br />
                                    <br />Some people have upper front teeth that stick out and look unsightly. These 'prominent' teeth are more likely to be damaged, but orthodontic treatment can move them back into line. Or the way the upper and lower jaws meet can cause teeth to look unsightly and lead to an incorrect bite. Orthodontic treatment may be able to correct both of these problems.<br />
                                    <br />When the teeth don't meet correctly, this can put strain on the muscles of the jaw, causing jaw and joint problems and sometimes headaches. Orthodontic treatment can help you to bite more evenly and reduce the strain.
                                    </div>
                                </div>
                            </div>
                            <div className="panel panel-default">
                            ...
                            <div className="panel panel-default">
                                ...
                                <div id="collapse4" className="panel-collapse collapse" role="tabpanel" aria-labelledby="heading4">
                                    <div className="panel-body">
                                    The most important thing is to have a full examination. This will usually involve looking at your teeth, taking <strong>dental x-rays</strong> and making plaster models of your teeth.<br />
                                    <br />Your dental team or orthodontist will then discuss what treatment is possible. Once you are sure you want to go ahead, the treatment can start as soon as you have enough permanent teeth.
                                    </div>
                                </div>
                            </div>
                            <div className="panel panel-default">
                            ...
                            <div className="panel panel-default">
                                ...
                                <div id="collapse12" className="panel-collapse collapse" role="tabpanel" aria-labelledby="heading12">
                                    <div className="panel-body">
                                    They are tough, clear plastic 'aligners' (moulds) that are used to straighten teeth. Several sets of specially moulded, slightly different aligners are made for each patient. Each set is worn for two weeks before being replaced with the next one. They are made from clear plastic, so they are nearly invisible. This means that no one need know you are straightening your teeth.<br />
                                    <br />The aligners should be worn for 22 to 23 hours a day for the best results. They can be easily removed for eating, drinking, brushing, and for cleaning in between your teeth. You need to have all your adult teeth before you can have this treatment.
                                    </div>
                                </div>    
                            </div>
                            <div className="panel panel-default">
                            ...
                            <div className="panel panel-default">
                                ...
                                <div id="collapse15" className="panel-collapse collapse" role="tabpanel" aria-labelledby="heading15">
                                    <div className="panel-body">
                                    When treatment is finished the teeth need to be held in position for a time. This is called the ‘retention' period, and the appliances that hold the teeth in place are called retainers.<br />
                                    <br />The retainers hold newly straightened teeth in position while the surrounding gum and bone settles. The retainers can be removable or fixed, depending on the original problem.
                                    </div>
                                </div>    
                            </div>
                            <div className="panel panel-default">
                            ...
                            <div className="panel panel-default">
                                ...
                                <div id="collapse18" className="panel-collapse collapse" role="tabpanel" aria-labelledby="heading18">
                                    <div className="panel-body">
                                    Success depends on both the skills of the orthodontist, and the enthusiasm and helpfulness of the patient (and parents, if the patient is a child). It is important to follow any instructions given by the orthodontist and to go to any appointments you have with them.<br />
                                    <br />The success of the treatment also depends on the commitment of the patient. For children's orthodontic treatment it is very important that the patient is as keen as the parent.
                                    </div>
                                </div>
                            </div>
                            <div className="panel panel-default">
                            ...
                            <div className="panel panel-default">
                                <div className="panel-heading" role="tab" id="heading20">
                                    <h4 className="panel-title">
                                        <a className="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse20" aria-expanded="false" aria-controls="collapse20">
                            ...
                            <div className="panel panel-default">
                                <div className="panel-heading" role="tab" id="heading21">
                                    <h4 className="panel-title">
                                        <a className="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse21" aria-expanded="false" aria-controls="collapse21">
                            ...
                            <div className="panel panel-default">
                                ...
                                <div id="collapse22" className="panel-collapse collapse" role="tabpanel" aria-labelledby="heading22">
                                    ...
                                    <ul>
                                        ...
                                        <li>Brush your teeth last thing at night and at least one other time during the day. Use a mouthwash if you need to. Your dental team may recommend a stronger <strong>fluoride toothpaste</strong>, or perhaps a fluoride gel or mouth rinse, for you to use.</li>
                                    </ul>
                                    </div>
                                </div>
                            </div>    
