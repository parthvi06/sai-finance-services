    ...
    render() {
        return (
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <h2>MY LATEST braces head</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit tellus.</p>
                        <a className="more">Book appointment</a>
                        <img src="/assets/img/LearningToBrushTeeth.jpg" />
                    </div>
                </div>
                </section>
                <section>
                <div className="container">
                    <div className="row">
                        ...
                        <p>Orthodontic treatment commonly uses fixed or removable braces to treat misalignment of the teeth or jaws, or sometimes both. Common problems that are corrected by an orthodontist include:
